...
{
    public static WebApplicationBuilder WithCoreEnvironment<TAppSettings>(this WebApplicationBuilder builder,
        out TAppSettings appSettings,
        string folderName = "AppSettings"
        ...
        where TAppSettings : class, IAppSettings
    {
        ...
        foreach (var property in properties)
        {
            ...
            if (propertyValue is null)
                throw new NullReferenceException($"Configuration '{propertyType.Name}' was not found");
